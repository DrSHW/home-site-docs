...
def query_book(request):
    return JsonResponse(request.GET)	# 返回结果
```

<img src="https://images.drshw.tech/images/notes/image-20221102240632973.png" alt="image-20221102240632973" style="zoom:40%;" />

访问URL时，会打印查询结果：

<img src="https://images.drshw.tech/images/notes/image-20221102240836436.png" alt="image-20221102240836436" style="zoom:40%;" />
