...
![image-20221104230758722](https://images.drshw.tech/images/notes/image-20221104230758722.png)
...
访问`http://127.0.0.1:8000/book/response/`进行测试（路由配置：`path(path('response/', response))`）：

![image-20221104234649843](https://images.drshw.tech/images/notes/image-20221104234649843.png)
