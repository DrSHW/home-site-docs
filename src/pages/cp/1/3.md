...
![image-20221229200254513](C:/Users/17100/AppData/Roaming/Typora/typora-user-images/image-20221229200254513.png)
...
>
> 如果此时外部样式并没有加载完成，渲染出来的就是浏览器的**默认样式**了，这也是网速卡顿的情况下有时会丢失CSS的原因。
...
若想一条条地执行这三条指令，可以通过中途加入强制渲染指令实现，例如：
